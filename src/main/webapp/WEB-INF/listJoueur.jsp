...
<body>
	...
	<main role="main" class="container">
		...
		<div class="starter-template">
			...
			<br />
			<h1>Joueurs</h1>
			<p class="lead">Liste des joueurs de tennis.</p>
		</div>

	</main>


	<%-- ///////////////////////////////Champ joueur selectionné //////////////////////////////// --%>



	<form class="needs-validation " method="Post" action="ListJoueur"
		novalidate>
		...
		<c:if test="${ sessionScope.profilUser == 1}">
			<div id="champTxt">
				...
				<label for="validationCustom00">Id</label> <input type="text"
					...
					name="txtId" value="${lastSelectedJoueur.getId()}" required>
				...
				<label for="validationCustom01">Nom</label> <input type="text"
					...
					name="txtNom" value="${lastSelectedJoueur.getNom()}" required>
				<div class="valid-feedback">Très bien!</div>
				...
				<label for="validationCustom02">Prénom</label> <input type="text"
					...
					name="txtPrenom" value="${lastSelectedJoueur.getPrenom()}" required>
				<div class="valid-feedback">Très bien!</div>



				<label for="validationCustom03">Sexe</label> <input type="text"
					class="form-control" style="width: 80px;" id="validationCustom03"
					name="txtSexe" value="${lastSelectedJoueur.getSexe()}" required>
				<div class="valid-feedback">Très bien!</div>
		...
		<div id="elementCrud">
			...
			<button type="submit" name="rechercherJoueur"
				class="btn btn-outline-primary">Rechercher joueur</button>
			...
			<c:if test="${ sessionScope.profilUser == 1}">
				...
				<button type="submit" id="addJoueur" name="addJoueur"
					class="btn btn-primary">Ajouter joueur</button>


				<%-- Editer --%>

				<button type="submit" name="editJoueur" class="btn btn-warning">Editer
					joueur</button>


				<%-- Supprimer --%>

				<button type="submit" name="deleteJoueur" class="btn btn-danger">Supprimer
					joueur</button>
	...
	<div style="padding: 2rem; margin-right: 200px; margin-left: 200px;">
		<table class="table">
			...
			<tbody>
				...
				<c:forEach items="${dataJoueur}" var="joueur">
					<tr>
						...
						<td><form action="ListJoueur" method="post">
								<input type="hidden" name="joueurId" value="${joueur.getId()}" />
								<button type="submit" name="selectedJoueur"
